...
import {
  ...
  Brain, X, Crown, Sparkles, Clock, Shield, Copy, Check,
} from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Skeleton } from "@/components/ui/skeleton";
import Link from "next/link";
import { BadgeGrid, BadgeCard } from "@/components/BadgeGrid";
import { pageEntrance, staggerItem, statReveal, badgeContainer, badgeItem } from "@/lib/motion";
...
export default function ProfilePage() {
  ...
  // Find highest stat for emphasis
  const stats = [
    ...
    { key: "tryhackmePoints", label: "THM Points", value: profile?.tryhackmePoints || 0, color: "success" as const },
    { key: "tryhackmeRank", label: "THM Rank", value: profile?.tryhackmeRank || 0, color: "destructive" as const },
  ];
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {profile.badges && profile.badges.length > 0 && (
          <motion.div variants={staggerItem} className="glass-card p-6">
            ...
            {/* AI badges grid */}
            {aiBadges.length > 0 && (
              <motion.div variants={badgeContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {/* Stats — 4-up with emphasis on highest */}
        <motion.div variants={staggerItem} className="glass-card p-6">
